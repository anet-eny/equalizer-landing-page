  ...
  return (
    <section className="relative pt-800 pb-2500">
      ...
      <img
        src={bgDesktop}
        alt=""
        className="absolute -top-20 hidden md:block max-w-[1600px]"
      />
      <img
        src={bgPattern}
        alt=""
      ...
      <div className="relative z-10 px-250 sm:px-500 md:px-1000">
        ...
        <p className="mt-500 text-preset-5 sm:text-preset-4 sm:text-lg md:text-preset-4 text-slate sm:max-w-lg md:max-w-4xl">
